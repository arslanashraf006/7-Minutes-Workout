...
class BMIActivity : AppCompatActivity() {
    ...
    private var currentVisibleView : String = METRIC_UNITS_VIEW // a var to hold value to make selected view visible
    ...
    private fun calculateUnits(){
        if(currentVisibleView == METRIC_UNITS_VIEW){
            if (validateMetricUnits()){
                val heightValue : Float = binding?.etMetricUnitHeight?.text.toString().toFloat() / 100 //convert cm to meter div by 100
